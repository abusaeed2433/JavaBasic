...
import q_Interfaces.conflicts.Player;
import q_Interfaces.conflicts.RunAndWalkable;
import q_Interfaces.random.Child;
import q_Interfaces.with.Bird;
import q_Interfaces.with.Flyable;
import q_Interfaces.with.Girl;
import q_Interfaces.without.Animal;
import q_Interfaces.without.Duck;
import q_Interfaces.without.Person;
import q_Interfaces.without.Walkable;
...
public class Main {
    ...
    private void randomTest(){
        q_Interfaces.conflicts.Walkable walkable = new Child(1);
        walkable.walk();
    ...
    private void interfaceConflict(){
        ...
        q_Interfaces.conflicts.Walkable walkable = new Player(1);
